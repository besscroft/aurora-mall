 ...
 */
public class BmsUpdateLog implements Serializable {
    ...
    /** 子日志 */
    private List<BmsUpdateLogDetail> detail;
    ...
    public List<BmsUpdateLogDetail> getDetail() {
        return detail;
    }

    public void setDetail(List<BmsUpdateLogDetail> detail) {
        this.detail = detail;
    }
