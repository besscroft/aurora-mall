...
INSERT INTO `config_info` VALUES (9, 'mall-id-generator-dev.yaml', 'DEFAULT_GROUP', 'spring:\n  main:\n    allow-bean-definition-overriding: true\n  datasource:\n    druid:\n      db-type: com.alibaba.druid.pool.DruidDataSource\n      driverClassName: com.mysql.jdbc.Driver\n      url: jdbc:mysql://localhost:3306/aurora-mall?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\n      username: root\n      password: 666666\n      # 初始连接数\n      initial-size: 5\n      # 最小连接数\n      min-idle: 10\n      # 最大连接数\n      max-active: 20\n      # 获取连接超时时间\n      max-wait: 5000\n      # 连接有效性检测时间\n      time-between-eviction-runs-millis: 60000\n      # 连接在池中最小生存的时间\n      min-evictable-idle-time-millis: 300000\n      # 连接在池中最大生存的时间\n      max-evictable-idle-time-millis: 900000\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      # 检测连接是否有效\n      validation-query: select 1\n      # 配置监控统计\n      webStatFilter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        url-pattern: /druid/*\n        reset-enable: false\n      filter:\n        stat:\n          enabled: true\n          # 记录慢SQL\n          log-slow-sql: true\n          slow-sql-millis: 1000\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n  # JPA相关配置\n  jpa:\n    database-platform: org.hibernate.dialect.MySQL5InnoDBDialect\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n    # formatSQL\n    properties:\n      hibernate:\n        format_sql: true\n\nfeign:\n  okhttp:\n    enabled: true\n\n# 全局参数设置\nribbon:\n  # 服务请求处理超时时间（毫秒）\n  ReadTimeout: 120000\n  # 服务请求连接超时时间（毫秒）\n  ConnectTimeout: 10000\n  SocketTimeout: 10000\n  MaxAutoRetries: 0\n  MaxAutoRetriesNextServer: 1', '64561c7e5dbcf5db001e395ff188f68c', '2021-09-19 16:13:29', '2021-09-21 07:31:59', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (10, 'mall-log-dev.yaml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    #数据库索引\n    database: 0\n    host: 127.0.0.1\n    port: 6379\n    password: password\n    #连接超时时间\n    timeout: 5000\n  main:\n    allow-bean-definition-overriding: true\n  datasource:\n    druid:\n      db-type: com.alibaba.druid.pool.DruidDataSource\n      driverClassName: com.mysql.jdbc.Driver\n      url: jdbc:mysql://localhost:3306/aurora-mall?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\n      username: root\n      password: 666666\n      # 初始连接数\n      initial-size: 5\n      # 最小连接数\n      min-idle: 10\n      # 最大连接数\n      max-active: 20\n      # 获取连接超时时间\n      max-wait: 5000\n      # 连接有效性检测时间\n      time-between-eviction-runs-millis: 60000\n      # 连接在池中最小生存的时间\n      min-evictable-idle-time-millis: 300000\n      # 连接在池中最大生存的时间\n      max-evictable-idle-time-millis: 900000\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      # 检测连接是否有效\n      validation-query: select 1\n      # 配置监控统计\n      webStatFilter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        url-pattern: /druid/*\n        reset-enable: false\n      filter:\n        stat:\n          enabled: true\n          # 记录慢SQL\n          log-slow-sql: true\n          slow-sql-millis: 1000\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\n# MyBatis配置\nmybatis:\n  # 搜索指定包别名\n  typeAliasesPackage: com.besscroft.aurora.mall.common.entity\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/*Mapper.xml\n  configuration:\n    cache-enabled: false\n\n# PageHelper分页插件\npagehelper:\n  helperDialect: mysql\n  reasonable: true\n  supportMethodsArguments: true\n  params: count=countSql\n\nfeign:\n  okhttp:\n    enabled: true\n\n# 全局参数设置\nribbon:\n  # 服务请求处理超时时间（毫秒）\n  ReadTimeout: 120000\n  # 服务请求连接超时时间（毫秒）\n  ConnectTimeout: 10000\n  SocketTimeout: 10000\n  MaxAutoRetries: 0\n  MaxAutoRetriesNextServer: 1', '23753fd7eeddad353d4b97b82bbd3680', '2021-09-19 16:13:59', '2021-09-21 07:32:45', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '');
