...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (8, 1, 'mall-gateway-dev.yaml', 'DEFAULT_GROUP', '', 'spring:\n  security:\n    oauth2:\n      resourceserver:\n        jwt:\n          jwk-set-uri: \'http://localhost:8000/mall-auth/publicKey/get\' #配置RSA的公钥访问地址\n  redis:\n    #数据库索引\n    database: 0\n    host: 127.0.0.1\n    port: 6379\n    password: password\n    #连接超时时间\n    timeout: 5000\n  main:\n    allow-bean-definition-overriding: true\n  cloud:\n    gateway:\n      # 跨域\n#      globalcors:\n#        corsConfigurations:\n#          \'[/**]\':\n#            allowCredentials: true\n#            allowedOrigins: \"*\"\n#            allowedMethods: \"*\"\n#            allowedHeaders: \"*\"\n      routes:\n        # 认证中心的路由\n        # 路由 ID\n        - id: mall-auth\n          # 请求地址\n          uri: lb://mall-auth\n          # 断言（判断条件）\n          predicates:\n            - Path=/mall-auth/**\n          # 过滤器\n          filters:\n            # 去掉前缀\n            - StripPrefix=1\n            # 重写路径，也相当于去掉前缀了\n            # - RewritePath=/mall-auth/(?<segment>.*), /$\\{segment}\n        # 后台管理系统的路由\n        # 路由 ID\n        - id: mall-admin\n          # 请求地址\n          uri: lb://mall-admin\n          # 断言（判断条件）\n          predicates:\n            - Path=/mall-admin/**\n          # 过滤器\n          filters:\n            # 去掉前缀\n            - StripPrefix=1\n            # 重写路径，也相当于去掉前缀了\n            # - RewritePath=/mall-auth/(?<segment>.*), /$\\{segment}\n        # Elasticsearch中心的路由\n        # 路由 ID\n        - id: mall-elasticsearch\n          # 请求地址\n          uri: lb://mall-elasticsearch\n          # 断言（判断条件）\n          predicates:\n            - Path=/mall-elasticsearch/**\n          # 过滤器\n          filters:\n            # 去掉前缀\n            - StripPrefix=1\n            # 重写路径，也相当于去掉前缀了\n            # - RewritePath=/mall-auth/(?<segment>.*), /$\\{segment}\n        # 分布式ID服务的路由\n        # 路由 ID\n        - id: mall-id-generator\n          # 请求地址\n          uri: lb://mall-id-generator\n          # 断言（判断条件）\n          predicates:\n            - Path=/mall-id-generator/**\n          # 过滤器\n          filters:\n            # 去掉前缀\n            - StripPrefix=1\n            # 重写路径，也相当于去掉前缀了\n            # - RewritePath=/mall-auth/(?<segment>.*), /$\\{segment}\n        # 日志服务的路由\n        # 路由 ID\n        - id: mall-log\n          # 请求地址\n          uri: lb://mall-log\n          # 断言（判断条件）\n          predicates:\n            - Path=/mall-log/**\n          # 过滤器\n          filters:\n            # 去掉前缀\n            - StripPrefix=1\n            # 重写路径，也相当于去掉前缀了\n            # - RewritePath=/mall-auth/(?<segment>.*), /$\\{segment}\n      discovery:\n        locator:\n          enabled: true #开启从注册中心动态创建路由的功能\n          lower-case-service-id: true #使用小写服务名，默认是大写\nwhitelist:\n    urls: #配置白名单路径\n      - \"/doc.html\"\n      - \"/swagger-resources/**\"\n      - \"/swagger/**\"\n      - \"/*/v2/api-docs\"\n      - \"/*/*.js\"\n      - \"/*/*.css\"\n      - \"/*/*.png\"\n      - \"/*/*.ico\"\n      - \"/webjars/springfox-swagger-ui/**\"\n      - \"/actuator/**\"\n      - \"/mall-auth/auth/token\"\n      - \"/mall-auth/publicKey/get\"\n      - \"/mall-admin/user/login\"\n      - \"/mall-admin/user/register\"\n      - \"/mall-admin/user/logout\"      - \"/mall-auth/oauth/token\"      - \"/mall-auth/user/loadByUsername\"\n\n\n\n# 日志级别设置\nlogging:\n  level:\n    # nacos 日志级别\n    com:\n      alibaba:\n        nacos: warn', '1556547211c51eff83f382df72cfb01e', '2021-11-26 11:01:44', '2021-11-26 03:01:45', 'nacos', '0:0:0:0:0:0:0:1', 'U', '');
